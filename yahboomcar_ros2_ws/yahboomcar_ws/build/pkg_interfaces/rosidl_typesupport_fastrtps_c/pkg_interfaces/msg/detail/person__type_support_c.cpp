...
#include "pkg_interfaces/msg/detail/person__rosidl_typesupport_fastrtps_c.h"
...
using _Person__ros_msg_type = pkg_interfaces__msg__Person;
...
static uint32_t _Person__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pkg_interfaces__msg__Person(
...
static size_t _Person__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pkg_interfaces__msg__Person(
