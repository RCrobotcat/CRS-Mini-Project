...
#include "pkg_interfaces/msg/detail/person__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pkg_interfaces::msg::Person & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pkg_interfaces::msg::Person & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const pkg_interfaces::msg::Person *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pkg_interfaces::msg::Person *>(
    untyped_ros_message);
...
{
  return &pkg_interfaces::msg::typesupport_fastrtps_cpp::_Person__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg_interfaces, msg, Person)() {
  return &pkg_interfaces::msg::typesupport_fastrtps_cpp::_Person__handle;
}
